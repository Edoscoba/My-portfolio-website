          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>This projects reflects my proficiency in leveraging HTML, CSS and javascript to create a visually appealing, functional, and user-centric web applications. </p>
